                    ...
                    <div class="auth-form">
                        <form>
                            ...
                            <div class="form-input">
                                ...
                                <input class="form-input__control" type="text" placeholder="" name="email" value="mqf10660@yuoia.com" />
                                <div class="form-input__error-text"></div>
                            </div>
                            <div class="auth-form__recovery">
                                <a class="auth-form__recovery-link" href="">Войти в личный кабинет</a>
                            </div>
