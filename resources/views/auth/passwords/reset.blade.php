...
<div class="setting-page">
    <div class="setting-page__container">
        <div>
            <h1 class="setting-page__title">{{ __('Смена пароля') }}</h1>
        </div>
            ...
            <div class="auth-form">
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-input">
                        ...
                        <input id="email" type="email" class="form-input__control form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
