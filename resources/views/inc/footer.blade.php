<div class="footer">
    <div class="container">
        <div class="footer__inner">
            <div class="footer__item footer__item--start footer__item--html">
                2021 ООО "Техноиндекс"<br />
                ИНН: 7839141703<br />
                ОГРН: 1217800097888<br />
                Тел.: +7 (499) 430-01-57<br />
                E-mail: support@marketseller.pro
            </div>
            <div class="footer__item footer__item--middle">
                <div class="footer__info footer__info--grey footer__info--ru">Платеж защищен</div>
                ...
                <div class="footer__info footer__info--grey footer__info--ru">Принимаем к оплате:</div>
                <div class="footer__pay footer__pay--ru">
                    <img
                        class="footer__img"
                        alt=""
            ...
            <div class="footer__item footer__item--ru">
                <a href="https://marketseller.pro/policy.pdf" target="_blank" rel="noreferrer noopener" class="footer__info footer__info--link footer__info--link-ru">Политика конфиденциальности</a>
                <a href="https://marketseller.pro/offer.pdf" target="_blank" rel="noreferrer noopener" class="footer__info footer__info--link footer__info--link-ru">Оферта</a>
                <a class="footer__info footer__info--link footer__info--link-ru" href="https://client.marketseller.pro/unsubscribe">Отменить подписку</a>
                <a href="https://marketseller.pro/permission.pdf" target="_blank" rel="noreferrer noopener" class="footer__info footer__info--link footer__info--link-ru">Политика обработки данных</a>
            </div>
        </div>
    </div>
</div>
